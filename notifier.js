...
function createTemplate(slotDetails, date){
    ...
    for(const slot of slotDetails){
        ...
        Location: ${slot.address}, ${slot.district_name}, ${slot.state_name}, ${slot.pincode} <br/>
...
exports.sendEmailMultiple = function (emails, subjectLine, slotDetails, date, callback) {
    let message = createTemplate(slotDetails, date)
